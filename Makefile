...
SRC_IPCOMP_TRANSP_IPV4 ?=	${PREFIX_IPV4}45.17
SRC_IPCOMP_TRANSP_IPV6 ?=	${PREFIX_IPV6}44::17
SRC_IPCOMP_TUNNEL_IPV4 ?=	${PREFIX_IPV4}48.17
SRC_IPCOMP_TUNNEL_IPV6 ?=	${PREFIX_IPV6}48::17
...
IPS_IPCOMP_TRANSP_IPV4 ?=	${PREFIX_IPV4}45.70
IPS_IPCOMP_TRANSP_IPV6 ?=	${PREFIX_IPV6}45::70
IPS_IPCOMP_TUNNEL4_IPV4 ?=	${PREFIX_IPV4}52.70
IPS_IPCOMP_TUNNEL4_IPV6 ?=	${PREFIX_IPV6}4c::70
IPS_IPCOMP_TUNNEL6_IPV4 ?=	${PREFIX_IPV4}53.70
IPS_IPCOMP_TUNNEL6_IPV6 ?=	${PREFIX_IPV6}4d::70
...
ECO_IPCOMP_TUNNEL4_IPV4 ?=	${PREFIX_IPV4}54.72
ECO_IPCOMP_TUNNEL4_IPV6 ?=	${PREFIX_IPV6}4e::72
ECO_IPCOMP_TUNNEL6_IPV4 ?=	${PREFIX_IPV4}55.72
ECO_IPCOMP_TUNNEL6_IPV6 ?=	${PREFIX_IPV6}4f::72
...
run-regress-ping run-regress-${host} run-regress-${sec} run-regress-${mode}\
    run-regress-${ipv}: run-regress-ping-${host}_${sec}_${mode}_${ipv}
...
run-regress-udp run-regress-${host} run-regress-${sec} run-regress-${mode}\
    run-regress-${ipv}: run-regress-udp-${host}_${sec}_${mode}_${ipv}
...
run-regress-tcp run-regress-${host} run-regress-${sec} run-regress-${mode}\
    run-regress-${ipv}: run-regress-tcp-${host}_${sec}_${mode}_${ipv}
