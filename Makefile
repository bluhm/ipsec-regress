...
SRC_NAT_IPV4 ?=	${PREFIX_IPV4}03.17
SRC_NAT_IPV6 ?=	${PREFIX_IPV6}03::17
SRC_ESP_NATTUNNEL_IPV4 ?=	${PREFIX_IPV4}97.17
SRC_ESP_NATTUNNEL_IPV6 ?=	${PREFIX_IPV6}97::17
...
IPS_NAT_IPV4 ?=	${PREFIX_IPV4}03.70
IPS_NAT_IPV6 ?=	${PREFIX_IPV6}03::70
IPS_ESP_NATTUNNEL4_IPV4 ?=	${PREFIX_IPV4}98.70
IPS_ESP_NATTUNNEL4_IPV6 ?=	${PREFIX_IPV6}98::70
...
ECO_ESP_NATTUNNEL4_IPV4 ?=	${PREFIX_IPV4}99.72
ECO_ESP_NATTUNNEL4_IPV6 ?=	${PREFIX_IPV6}99::72
